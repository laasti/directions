...
class PeelsStrategyTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testNoRequest()
    {
        ...
        $strategy->callRoute(new \Laasti\Directions\Route('GET', '/fake', function () {
        }, $strategy));
    }
    ...
    public function testRouteMiddleware()
    {
        ...
        $strategy->setRequest(new \Zend\Diactoros\ServerRequest());
        $strategy->setResponse(new \Zend\Diactoros\Response());
        $route = new \Laasti\Directions\Route('GET', '/fake', function () {
        }, $strategy);
        $route->pushMiddleware(function ($request, $response, $next) {
            return 5;
        });
    ...
    {
        return new \Laasti\Directions\Strategies\HttpMessageStrategy(new \Zend\Diactoros\ServerRequest,
